...
class IndexFacade
{
    ...
    public function export(AbstractIndex $index, IndexDefinition $indexDefinition, OutputInterface $output): void
    {
        ...
        $this->createForIndexWhenNeeded($indexDefinition, $output);
     ...
     * @param \Symfony\Component\Console\Output\OutputInterface $output
     */
    protected function createForIndexWhenNeeded(IndexDefinition $indexDefinition, OutputInterface $output): void
    {
        try {
